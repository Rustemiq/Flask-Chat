...
class UserResource(Resource):
    ...
    def put(self, user_id):
        ...
        birth_date = args['birth_date'] if args['birth_date'] is not None else user.birth_date
        response_if_invalid_date(birth_date)
        manager.edit_user(user_id, nickname=nickname, username=username, birth_date=birth_date)
