...
chat_edit_parser.add_argument('new_members', required=False, default=[], type=list, location='json')
chat_edit_parser.add_argument('to_kick_members', required=False, default=[], type=list, location='json')
